(function (ns) {
  ...
  var OverScene = ns.OverScene = Hilo.Class.create({
    ...
    show: function (score, bestScore) {
      ...
      Hilo.Tween.from(this.getChildById('board'), {alpha: 0, y: this.getChildById('board').y + 150}, {
        duration: 200,
        delay: 200
      });
      Hilo.Tween.from(this.getChildById('score'), {alpha: 0, y: this.getChildById('score').y + 150}, {
        duration: 200,
        delay: 200
      });
      Hilo.Tween.from(this.getChildById('best'), {alpha: 0, y: this.getChildById('best').y + 150}, {
        duration: 200,
        delay: 200
      });
